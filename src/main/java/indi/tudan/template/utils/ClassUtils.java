...
public class ClassUtils {
     ...
     * 根据类，获取当前程序所在路径
     *
     * @param sourceClass 类的类型
     * @return 所在路径
     * @date 2019-10-31 14:28:11
     */
    public static String getCurrentProgramPath(Class<?> sourceClass) {
        ApplicationHome h = new ApplicationHome(sourceClass);
